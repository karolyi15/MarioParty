...
import Controllers.Models.SpriteFactories.Graphics.Button;
...
public class Tictactoe implements iMiniGame {
    ...
    public void initGame(Scene_Controller sceneController){
        ...
        Background img=(Background) this.spriteFactory.createBackground(this.gameType);
        img.resize(700,500);
        this.componentList.add(img);
